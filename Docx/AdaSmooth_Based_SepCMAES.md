/opt/conda/envs/loren/lib/python3.11/site-packages/cmaes/_sepcma.py

请你参考 CMA 的 covariance matrix 更新方法，完成 AdaSmoothZO 中的协方差$L_t$矩阵更新代码。

num_queries 不一定要和 $L_t$ 的 rank 一致，请你帮我设计最好的 $L_t$ 形式，帮我然后帮我进行测试和对比，但是 AdaSmooth 的数学公式和更新逻辑必须要正确。
